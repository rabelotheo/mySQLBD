...
SELECT * FROM tb_produtos ORDER BY preco IN(5, 10, 15);

SELECT * FROM tb_produtos ORDER BY nome IN("Couve", "Banana");

SELECT * FROM tb_produtos ORDER BY preco BETWEEN 5 AND 15;

SELECT * FROM tb_produtos ORDER BY nome LIKE "%ra%";
...
SELECT SUN(preco) FROM tb_produtos;
